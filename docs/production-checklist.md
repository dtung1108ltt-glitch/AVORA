...
- Mock interview microphone transcription succeeds through `/api/speech-to-text` when `OPENAI_API_KEY` is configured (OpenAI Whisper); otherwise verify typed interview responses still submit.
