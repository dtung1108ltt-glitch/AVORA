...
export default function LoginPage() {
  ...
  const handleOAuthLogin = async (provider: 'google' | 'microsoft' | 'github' | 'linkedin') => {
    try {
      setFormError(null);
            ...
            <>
              <div className="space-y-3 mb-6">
                ...
                >
                  ...
                  <span className="font-medium text-stone-700">Continue with GitHub</span>
                </button>
                ...
                >
                  ...
                  <span className="font-medium text-stone-700">Continue with LinkedIn</span>
                </button>
              </div>
